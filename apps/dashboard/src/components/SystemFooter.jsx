...
export default function SystemFooter() {
  ...
  useEffect(() => {
    const poll = () => api.listWranglers().then(setWranglers).catch(() => {});
    poll();
  ...
  return (
    <footer className="card" style={{ margin: 'var(--sp-4)' }}>
      ...
      <div className="live-row" style={{ padding: 'var(--sp-2) var(--sp-4)', fontSize: 'var(--text-sm)', color: 'var(--text-disabled)' }}>
